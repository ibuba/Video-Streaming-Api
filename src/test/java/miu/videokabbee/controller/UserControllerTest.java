...
//        UserController userController = new UserController(userInterfaceService,
//                passwordEncoder, new TokenService());
//        ResponseEntity<String> actualLogoutResult =
//        userController.logout(new MockHttpServletRequest());
